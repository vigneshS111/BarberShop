  ...
  return (
    <div className="flex md:flex-row flex-col justify-between items-end py-12 sm:px-20 px-6 gap-10 WhyChooseUs">
      <div className="flex flex-col justify-start gap-5 w-full text-black md:text-white ">
        ...
        <h3 className="text-wrap font-poppins md:text-[29px] text-[26px] font-semibold">
          In addition, there 5 more reasons why men prefer Manhattan Barbershop
          N.Y.C:
        </h3>
        <ul className="flex flex-col list-disc text-sm font-poppins font-light  gap-3 px-5">
      ...
      <div className="flex flex-col justify-center gap-6 w-full bg-white rounded-2xl text-black py-8">
        <h2 className="text-wrap flex justify-center font-poppins md:text-[45px] text-[40px] font-extrabold text-primary">
          WORKING HOURS
        </h2>
        <ul className="flex flex-col justify-center items-center  list-none  font-poppins font-light  gap-3 px-5">

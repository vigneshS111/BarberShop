  ...
  return (
    <div className="bg-secondary">
      <div className="py-12 sm:px-20 px-6 flex flex-col gap-10 justify-center items-center md:absolute md:top-[600px] md:left-[60px]">
        <h2 className="text-wrap font-poppins md:text-[45px] tracking-wide text-[40px] font-extrabold text-white">
      ...
      <div className="flex flex-col md:pt-[600px] justify-center items-center pb-8 ">
        <h2 className="text-wrap font-poppins md:text-[45px] text-[40px] tracking-wide font-extrabold text-white">
          People Comments{""}
        </h2>

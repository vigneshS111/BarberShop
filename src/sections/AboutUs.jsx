  ...
  return (
    <div className=" flex justify-between py-6 flex-row sm:px-32 px-6 gap-5  ">
      <div className="flex flex-col gap-10  justify-start">
        ...
        <h2 className="text-wrap font-poppins md:text-[58px] text-[54px] font-extrabold md:leading-[65px] leading-[65px] ">
          Licensed
        ...
        <div className="flex justify-start  w-full ">
          <a href="#bookNow">
            <div className="border-black border rounded-md px-5 py-4 hover:bg-gray-500 text-white bg-black cursor-pointer font-semibold font-poppins tracking-wide">
              BOOK AN APPOINTMENT
            </div>
          </a>
        </div>
